...
function TutorialModal({ close }: { close: () => void }) {
  ...
  const steps = [
    ...
    { title: 'Private, informed, and in control', text: 'Activity holds friend requests and list updates. Account controls your picture, username, discoverability, and request policy. Hushful confirms destructive actions before anything is removed.' },
  ]
