...
export interface WishlistItem {
  id: string; title: string; url?: string; price?: number; ownerNote?: string;
  createdAt: string; updatedAt: string; wishlist: { id: string }
}
export interface SharedWishlist { shareToken: string; title: string; sharedByName?: string }
export interface SharedNote { authorDisplayName?: string; updatedAt?: string; note: string }
export interface SharedItemRow {
  purchasedByMe: boolean; purchased: boolean; notes: SharedNote[];
  item: WishlistItem
}
